...
const authConfig = defineConfig({
  providers: [
    GitHub({
      clientId: "Ov23licLcwArVMQqzQ3E",
      clientSecret: "1f1099c343c15be439db69a52b91f34677c6f937"
    })
  ]
});
...
function AstroAuth(options = authConfig) {
  const { AUTH_SECRET, AUTH_TRUST_HOST, VERCEL, NODE_ENV } = Object.assign(__vite_import_meta_env__, { AUTH_TRUST_HOST: "true", AUTH_SECRET: "wwXRF4gEc6U3SrKyaRoGP54CMRw81JTBSrxyWrplEAjyh0Sc9F4QBA3IiJA=", NODE: process.env.NODE, NODE_ENV: process.env.NODE_ENV });
